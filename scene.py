...
class Scenes:
    ...
    def start(self):
        ...
        player = Player(mapimgdata.load_img("imgs/man.png", -1), "戦士", 100, 50, 10, 10, 10, 10, 10, 0, 0 ,0, 0, [0], [0 for _ in range(7)], 32, 32)
        players: list = [
            player,
            Player(mapimgdata.load_img("imgs/man.png", -1), "魔法使い", 5, 3, 10, 10, 10, 10, 10, 8, 0, 0, 0, [0], [0 for _ in range(7)]),
            Player(mapimgdata.load_img("imgs/man.png", -1), "僧侶", 5, 3, 10, 10, 10, 10, 10, 0, 15, 0, 0, [0], [0 for _ in range(7)]),
            Player(mapimgdata.load_img("imgs/man.png", -1), "武闘家", 5, 3, 10, 10, 10, 10, 10, 20, 0, 0, 0, [0], [0 for _ in range(7)]),
        ]

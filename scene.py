...
class Scenes:
    ...
    def start(self):
        ...
        players: list = [
            player,
            Player(mapimgdata.load_img("imgs/man.png", -1), "モブ1", 5, 3, 10, 10, 10, 10, 10, 0, 0, 0, 0, [0], [0 for _ in range(7)]),
            Player(mapimgdata.load_img("imgs/man.png", -1), "モブ2", 5, 3, 10, 10, 10, 10, 10, 0, 0, 0, 0, [0], [0 for _ in range(7)]),
            Player(mapimgdata.load_img("imgs/man.png", -1), "モブ3", 5, 3, 10, 10, 10, 10, 10, 0, 0, 0, 0, [0], [0 for _ in range(7)]),
        ]
